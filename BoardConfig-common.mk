...
ifeq ($(wildcard $(PROD_CERTS)/phoenix_security.mk),)
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := external/avb/test/data/testkey_rsa2048.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA2048
else
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := $(PROD_CERTS)/phoenix_rsa4096.pem
...
BOARD_AVB_BOOT_KEY_PATH := $(PROD_CERTS)/phoenix_rsa4096.pem
